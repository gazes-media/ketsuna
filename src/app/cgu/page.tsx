  ...
  return (
    <div>
      ...
      <Container maxWidth="md">
        <p>
          La présente Politique de confidentialité régit la manière dont Ketsuna
          collecte, utilise, traite et protège les informations personnelles des
          utilisateurs lorsqu'ils interagissent avec le bot Discord Ketsuna.
        </p>
        ...
        <p>
          Comme mentionné précédemment, Ketsuna ne collecte aucune donnée
          personnelle des utilisateurs. Par conséquent, aucune donnée
          personnelle n'est utilisée, traitée ou partagée avec des tiers.
        </p>
        <h2>Cookies</h2>
        <p>
          Ketsuna n'utilise pas de cookies pour collecter des informations
          personnelles.
        </p>
        <h2>Sécurité</h2>
        <p>
        ...
        <p>
          Les développeurs de Ketsuna se réservent le droit de modifier la
        ...
        <p>
          ...
          confidentialité de Ketsuna, veuillez nous contacter par email à
