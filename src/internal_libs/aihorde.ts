...
export class AIHorde {
  static readonly ModelGenerationInputStableSamplers =
    ModelGenerationInputStableSamplers;
  readonly ModelGenerationInputStableSamplers =
    AIHorde.ModelGenerationInputStableSamplers;
  ...
  static readonly ModelGenerationInputPostProcessingTypes =
    ModelGenerationInputPostProcessingTypes;
  readonly ModelGenerationInputPostProcessingTypes =
    AIHorde.ModelGenerationInputPostProcessingTypes;

  static readonly ModelGenerationInputControlTypes =
    ModelGenerationInputControlTypes;
  readonly ModelGenerationInputControlTypes =
    AIHorde.ModelGenerationInputControlTypes;
  ...
  ): Promise<{ result: Centra.Response; fields_string?: string }> {
   ...
   */
  async findUser<T extends keyof UserDetails>(options?: {
    token?: string;
    fields?: T[];
    ...
    if (result.statusCode === 404)
      throw new this.APIError(
        await result.json().then((res) => res),
        result.coreRes,
      );
   ...
   * @returns UserDetails - The user data of the requested user
   */
  async getUserDetails<T extends keyof UserDetails>(
    id: number,
    options?: { token?: string; force?: boolean; fields?: T[] },
  ): Promise<Pick<UserDetails, T>> {
   ...
   */
  async getTeam<T extends keyof TeamDetailsStable>(
    id: string,
    options?: { token?: string; force?: boolean; fields?: T[] },
   ...
   */
  async getWorkerDetails<T extends keyof WorkerDetailsStable>(
    id: string,
    options?: { token?: string; force?: boolean; fields?: T[] },
    ...
    const t = this.#getToken(options?.token);
    const temp =
      !options?.force && this.#cache.workers?.get(id + fields_string);
   ...
   */
  async getImageGenerationCheck<T extends keyof RequestStatusCheck>(
    id: string,
    options?: { force?: boolean; fields?: T[] },
    ...
    const req = Centra(`${this.#api_route}/generate/check/${id}`, "GET").header(
      "Client-Agent",
      this.#client_agent,
    );
    if (fields_string) req.header("X-Fields", fields_string);
   ...
   */
  async getImageGenerationStatus<T extends keyof RequestStatusStable>(
    id: string,
    options?: { force?: boolean; fields?: T[] },
    ...
    const req = Centra(
      `${this.#api_route}/generate/status/${id}`,
      "GET",
    ).header("Client-Agent", this.#client_agent);
    if (fields_string) req.header("X-Fields", fields_string);
    const res = await req.send();
   ...
   * @returns RequestStatusStable - The Status of the Generation
   */
  async getTextGenerationStatus<T extends keyof RequestStatusKobold>(
    id: string,
    options?: { force?: boolean; fields?: T[] },
    ...
    const req = Centra(
      `${this.#api_route}/generate/text/status/${id}`,
      "GET",
    ).header("Client-Agent", this.#client_agent);
    if (fields_string) req.header("X-Fields", fields_string);
    const res = await req.send();
   ...
   */
  async getInterrogationStatus<T extends keyof InterrogationStatus>(
    id: string,
    options?: { force?: boolean; fields?: T[] },
    ...
    const req = Centra(
      `${this.#api_route}/interrogate/status/${id}`,
      "GET",
    ).header("Client-Agent", this.#client_agent);
    if (fields_string) req.header("X-Fields", fields_string);
    const res = await req.send();
   ...
   */
  async getModels<T extends keyof ActiveModel>(options?: {
    force?: boolean;
    fields?: T[];
    ...
    const temp =
      !options?.force &&
      this.#cache.models?.get("CACHE-MODELS" + fields_string);
    if (temp) return temp as Pick<ActiveModel, T>[];
    const req = Centra(`${this.#api_route}/status/models`, "GET").header(
      "Client-Agent",
      this.#client_agent,
    );
    if (fields_string) req.header("X-Fields", fields_string);
   ...
   */
  async getModes<T extends keyof HordeModes>(options?: {
    token?: string;
    force?: boolean;
    fields?: T[];
   ...
   */
  async getNews<T extends keyof Newspiece>(options?: {
    force?: boolean;
    fields?: T[];
    ...
    const req = Centra(`${this.#api_route}/status/news`, "GET").header(
      "Client-Agent",
      this.#client_agent,
    );
    if (fields_string) req.header("X-Fields", fields_string);
   ...
   */
  async getPerformance<T extends keyof HordePerformanceStable>(options?: {
    force?: boolean;
    fields?: T[];
    ...
    const req = Centra(`${this.#api_route}/status/performance`, "GET").header(
      "Client-Agent",
      this.#client_agent,
    );
    if (fields_string) req.header("X-Fields", fields_string);
   ...
   */
  async getUsers<T extends keyof UserDetails>(options?: {
    fields?: T[];
  }): Promise<Pick<UserDetails, T>[]> {
    const fields_string = options?.fields?.length
      ? options.fields.join(",")
      : "";
    const req = Centra(`${this.#api_route}/users`, "GET").header(
      "Client-Agent",
      this.#client_agent,
    );
    if (fields_string) req.header("X-Fields", fields_string);
   ...
   */
  async getWorkers<T extends keyof WorkerDetailsStable>(options?: {
    fields?: T[];
  }): Promise<Pick<WorkerDetailsStable, T>[]> {
    const fields_string = options?.fields?.length
      ? options?.fields.join(",")
      : "";
    const req = Centra(`${this.#api_route}/workers`, "GET").header(
      "Client-Agent",
      this.#client_agent,
    );
    if (fields_string) req.header("X-Fields", fields_string);
   ...
   */
  async getImageModelStats<T extends keyof ImageModelStats>(options?: {
    fields?: T[];
   ...
   */
  async getImageTotalStats<T extends keyof ImageModelStats>(options?: {
    fields?: T[];
   ...
   */
  async getTextModelStats<T extends keyof ImageModelStats>(options?: {
    fields?: T[];
   ...
   */
  async getTextTotalStats<T extends keyof ImageModelStats>(options?: {
    fields?: T[];
   ...
   */
  async getTeams<T extends keyof TeamDetailsStable>(options?: {
    fields?: T[];
  }): Promise<Pick<TeamDetailsStable, T>[]> {
    const fields_string = options?.fields?.length
      ? options?.fields.join(",")
      : "";
    const req = Centra(`${this.#api_route}/teams`, "GET").header(
      "Client-Agent",
      this.#client_agent,
    );
    if (fields_string) req.header("X-Fields", fields_string);
   ...
   */
  async getFilters<T extends keyof FilterDetails>(
    filter_type?: string,
   ...
   */
  async getFilter<T extends keyof FilterDetails>(
    filter_id?: string,
    options?: { token?: string; fields?: T[] },
  ): Promise<Pick<FilterDetails, T>> {
    const fields_string = options?.fields?.length
   ...
   */
  async postFilters<T extends keyof FilterPromptSuspicion>(
   ...
   */
  async postAsyncImageGenerate<T extends keyof RequestAsync>(
   ...
   * @returns RequestAsync - The id and message for the async generation request
   */
  async postAsyncTextGenerate<T extends keyof RequestAsync>(
   ...
   */
  async postRating<T extends keyof GenerationSubmitted>(
    ...
    const t = this.#getToken(options?.token);
    const req = Centra(
      `${this.#api_route}/generate/rate/${generation_id}`,
      "POST",
    )
      .header("Client-Agent", this.#client_agent)
      .header("apikey", t)
   ...
   */
  async postImageGenerationPop<T extends keyof GenerationPayloadStable>(
  ...
  async getLorasModels(
    ...
    const req = Centra(
      `https://civitai.com/api/v1/models?types=LORA&limit=${
        options.limit
      }&query=${encodeURIComponent(name)}&page=${options.page}`,
      "GET",
    );
    const res = await req.send();
    switch (res.statusCode) {
    ...
    return (await res.json()) as CivitAIModels;
  }
   ...
   */
  async postTextGenerationPop<T extends keyof GenerationPayloadKobold>(
   ...
   */
  async postImageGenerationSubmit<T extends keyof GenerationSubmitted>(
    generation_submit: { id: string; generation: string; seed: string },
    options?: { token?: string; fields?: T[] },
  ): Promise<Pick<GenerationSubmitted, T>> {
    const fields_string = options?.fields?.length
      ? options.fields.join(",")
   ...
   * @returns GenerationSubmitted
   */
  async postTextGenerationSubmit<T extends keyof GenerationSubmitted>(
    generation_submit: {
      id: string;
      generation: string;
   ...
   */
  async postAsyncInterrogate<T extends keyof RequestInterrogationResponse>(
   ...
   */
  async postInterrogationPop<T extends keyof InterrogationPopPayload>(
   ...
   * @returns GenerationSubmitted
   */
  async postInterrogationSubmit<T extends keyof GenerationSubmitted>(
    interrogation_submit: { id: string; result: string },
    options?: { token?: string; fields?: T[] },
  ): Promise<Pick<GenerationSubmitted, T>> {
    const fields_string = options?.fields?.length
      ? options.fields.join(",")
   ...
   */
  async postKudosTransfer<T extends keyof KudosTransferred>(
    transfer_data: { username: string; amount: number },
    options?: { token?: string; fields?: T[] },
   ...
   * @returns null
   */
  async postKoboldTransfer(
    user_id: string,
    transfer_data: { kai_id: string; kudos_amount: number; trusted: boolean },
   ...
   * @returns ModifyTeam
   */
  async createTeam<T extends keyof ModifyTeam>(
   ...
   * @returns HordeModes
   */
  async putStatusModes<T extends keyof HordeModes>(
    modes: {
      maintenance: boolean;
      shutdown: number;
      invite_only: boolean;
   ...
   * @returns ModifyUser
   */
  async updateUser<T extends keyof ModifyUser>(
   ...
   */
  async updateWorker<T extends keyof ModifyWorker>(
   ...
   * @returns ModifyTeam
   */
  async updateTeam<T extends keyof ModifyTeam>(
   ...
   */
  async addFilter<T extends keyof FilterDetails>(
   ...
   * @returns FilterDetails
   */
  async updateFilter<T extends keyof FilterDetails>(
   ...
   */
  async deleteImageGenerationRequest<T extends keyof RequestStatusStable>(
    id: string,
    options?: { fields?: T[] },
  ): Promise<Pick<RequestStatusStable, T>> {
    const fields_string = options?.fields?.length
   ...
   */
  async deleteTextGenerationRequest<T extends keyof RequestStatusKobold>(
    id: string,
    options?: { fields?: T[] },
  ): Promise<Pick<RequestStatusKobold, T>> {
    const fields_string = options?.fields?.length
   ...
   */
  async deleteInterrogationRequest<T extends keyof InterrogationStatus>(
    id: string,
    options?: { fields?: T[] },
  ): Promise<Pick<InterrogationStatus, T>> {
    const fields_string = options?.fields?.length
   ...
   */
  async deleteWorker<T extends keyof DeletedWorker>(
    id: string,
    options?: { token?: string; fields?: T[] },
   ...
   * @returns DeletedTeam
   */
  async deleteTeam<T extends keyof DeletedTeam>(
    id: string,
    options?: { token?: string; fields?: T[] },
   ...
   */
  async deleteIPTimeout<T extends keyof SimpleResponse>(
   ...
   * @returns SimpleResponse
   */
  async deleteFilter<T extends keyof SimpleResponse>(
    filter_id: string,
    options?: { token?: string; fields?: T[] },
  ): Promise<Pick<SimpleResponse, T>> {
    const fields_string = options?.fields?.length
...
export interface ModelGenerationInputStable {
  ...
  /**
   * An array of Loras to use for this request
   */
  loras?: Loras[];
  /**
   * @default 30
...
export type InterrogationPopFormPayloadStable = Partial<
  Record<
...
export type InterrogationFormResult = Partial<
  Record<
    (typeof AIHorde.ModelInterrogationFormTypes)[keyof typeof AIHorde.ModelInterrogationFormTypes],
    Record<string, any>
  >
...
class AIHordeRatings {
   ...
   */
  async getDatasets<T extends keyof DatasetGetResponse>(options?: {
    fields?: T[];
  }): Promise<Pick<DatasetGetResponse, T>[]> {
    const fields_string = options?.fields?.length
      ? options?.fields.join(",")
      : "";
    const req = Centra(`${this.#api_route}/datasets`, "GET").header(
      "Client-Agent",
      this.#client_agent,
    );
    if (fields_string) req.header("X-Fields", fields_string);
   ...
   */
  async getTeams<T extends keyof TeamsGetResponse>(options?: {
    fields?: T[];
   ...
   */
  async getNewRating<T extends keyof DatasetImagePopResponse>(
    image_options?: { dataset_id: string; model_name?: string },
    options?: { token?: string; fields?: T[] },
   ...
   * @returns InterrogationPopPayload
   */
  async postRating<T extends keyof RatePostResponse>(
    image_id: string,
