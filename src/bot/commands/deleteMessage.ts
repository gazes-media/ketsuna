    ...
    if (interaction.isMessageContextMenuCommand()) {
      if (!interaction.targetMessage.interaction)
        return interaction.reply({
          content: bt.__({
            phrase: "This message is not a command",
      ...
      if (
        ...
        interaction
          .deleteReply(interaction.targetMessage.id)
          .then(() => {
            i.edit({
              content: bt.__({
                phrase: "Message deleted",
                locale: interaction.locale,
              }),
            });
          })
          .catch((err) => {
            i.edit({
              content: bt.__({
                phrase: "An error occurred, the message could not be deleted",
                locale: interaction.locale,
              }),
            });
          });
        ...
        interaction.reply({
          content: bt.__({
            phrase: "You can't delete this message",
            locale: interaction.locale,
          }),
          ephemeral: true,
        });
